...
const PaymentSection = () => {
  return (
    <Link to="/payments-info" className="block group">
      <section className="py-16 bg-background transition-colors group-hover:bg-card/20 cursor-pointer">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <Card className="bg-card/50 border-border/50 text-center transition-all group-hover:border-foreground/30">
              <CardContent className="pt-6">
                <div className="w-12 h-12 bg-primary/10 rounded-full flex items-center justify-center mx-auto mb-4">
                  <DollarSign className="h-6 w-6 text-primary" />
                </div>
                <h3 className="font-semibold mb-2">30% Guaranteed</h3>
                <p className="text-sm text-muted-foreground">Upfront payment secured in escrow</p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-card/50 border-border/50 text-center transition-all group-hover:border-foreground/30">
              <CardContent className="pt-6">
                ...
                <p className="text-sm text-muted-foreground">Final payment released upon delivery</p>
              </CardContent>
            </Card>
